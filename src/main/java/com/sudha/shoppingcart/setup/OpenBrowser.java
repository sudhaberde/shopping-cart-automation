...
public class OpenBrowser {
	...
	// @Test(priority=1)
	/*
	 * public void startBrowser(){ //TODO add this info to readme
	 * //System.setProperty("webdriver.chrome.driver",
	 * "/Users/sudha/Downloads/geckodriver.exe");
	 * System.setProperty("webdriver.gecko.driver",
	 * "/Users/sudha/Downloads/geckodriver"); test =
	 * extent.startTest("OpenBrowser"); test.log(LogStatus.INFO,
	 * "Opening the Mozilla Browser"); /* FirefoxProfile profile = new
	 * FirefoxProfile(); profile.setPreference(FirefoxProfile.PORT_PREFERENCE,
	 * "localhost.localdomain"); FirefoxOptions FFOptions = new
	 * FirefoxOptions().setProfile(profile); webDriver = new
	 ...
	 * 
	 * capabilities.setBrowserName("firefox"); //capabilities.setVersion("");
	 * 
	...
	public void startBrowser() {
		...
		if ("chrome".equalsIgnoreCase(System.getProperty("browser"))) {
			System.setProperty("webdriver.chrome.driver", "/Users/sudha/Downloads/chromedriver");
